...
class CSVWatermarkStorage(IWatermarkStorage):
    """Implementación CSV para watermarks (desarrollo/testing)"""
    
    def __init__(self, csv_file_path: str, project_name: str, team: str = '', data_source: str = '', endpoint_name: str = ''):
        self.logger = LoggerService.get_logger(__name__)
        self.csv_file_path = csv_file_path
        self.project_name = project_name
        # Se aceptan pero no se usan en CSV (modo dev/testing)
