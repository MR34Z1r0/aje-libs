...
from ..services.loaders.s3_loader import S3Loader
from ..services.formatters.parquet_formatter import ParquetFormatter
from ..services.formatters.csv_formatter import CSVFormatter
...
class LoaderFactory:
    ...
    @classmethod
    def create(cls, loader_type: str, output_format: str, **config) -> ILoader:
        """
    ...
    @classmethod
    def register_loader(cls, loader_type: str, loader_class: Type[ILoader]):
